<?php
	...
	*/	
	class EExcelView extends CGridView
	{
        ...
        public function dataProcess($name,$data)
        {
            $name = explode(".", $name);
            $nc = count($name);
			...
			foreach($this->columns as $n=>$column)
			{
			    if($column->value!==null) 
                    ...
                    if (strpos($column->name,'.')===false) {
                        ...
                        //relationships support, for example: we wanna get the value of 'rdomain.googlepr' directly
                        $value = $this->dataProcess($column->name, $data[$row]);
                    }
