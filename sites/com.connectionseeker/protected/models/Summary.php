...
class Summary extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('semrushkeywords', 'length', 'max'=>500),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, domain_id, domain, googlepr, onlinesince, linkingdomains, inboundlinks, indexedurls, alexarank, mozrank, mozauthority, semrushor, acrank, uniquevisitors, facebookshares, twittershares, linkedinshares, semrushkeywords', 'safe', 'on'=>'search'),
		);
	}
