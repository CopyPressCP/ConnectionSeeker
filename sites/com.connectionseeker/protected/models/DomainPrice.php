...
/**
 * This is the model class for table "{{domain_price}}".
 *
 * The followings are the available columns in table '{{domain_price}}':
 * @property integer $id
 ...
 */
class DomainPrice extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return DomainPrice the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, domain_id, domain, price, memo, created, created_by', 'safe', 'on'=>'search'),
		);
	}
