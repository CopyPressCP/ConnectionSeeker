...
class Client extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('note, created, modified, last_visit_time,email_upon_completion', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, company, name, contact_name, email, telephone, cellphone, note, assignee, status, created, created_by, modified, modified_by, last_visit_time, last_visit_ip,email_upon_completion', 'safe', 'on'=>'search'),
		);
	}
    ...
    public function scopes()
    {
        return array(
            ...
            // leave it for now, we may have one role call "Agent"
            'byagent'=>array(
                'condition'=>'user_id='.Yii::app()->user->id,
            ),
            'byuser'=>array(
                'condition'=>'id='.User::model()->findByPk(Yii::app()->user->id)->client_id,
            ),
            /*
            'recently'=>array(
	...
	public function attributeLabels()
	{
		return array(
			...
			'email_upon_completion' => 'Email Upon Completion',
	...
	public function search()
	{
		...
		$criteria->compare('email_upon_completion',$this->email_upon_completion);
