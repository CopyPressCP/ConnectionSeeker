...
/**
 * This is the model class for table "{{content_step_history}}".
 *
 * The followings are the available columns in table '{{content_step_history}}':
 * @property string $id
 * @property integer $task_id
 * @property integer $newvalue
 * @property integer $oldvalue
 * @property integer $timeline
 * @property string $role
 * @property string $created
 * @property integer $created_by
 */
class Stephistory extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('task_id, newvalue, created_by', 'required'),
			array('task_id, newvalue, oldvalue, timeline, created_by', 'numerical', 'integerOnly'=>true),
			array('role', 'length', 'max'=>255),
			array('created, reason', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, task_id, newvalue, oldvalue, timeline, role, reason, created, created_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('oldvalue',$this->oldvalue);
