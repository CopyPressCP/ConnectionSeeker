...
class Iohistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('task_id, iostatus, oldiostatus, timeline, created_by', 'numerical', 'integerOnly'=>true),
			array('role', 'length', 'max'=>255),
			array('created, reason', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, task_id, iostatus, oldiostatus, timeline, role, reason, created, created_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'task_id' => 'Task',
			'oldiostatus' => 'Old IO Status',
			'iostatus' => 'New IO Status',
			'timeline' => 'Timeline',
			'role' => 'Role',
			'reason' => 'Reason',
			'created' => 'Created',
	...
	public function search()
	{
		...
		$criteria->compare('oldiostatus',$this->oldiostatus);
