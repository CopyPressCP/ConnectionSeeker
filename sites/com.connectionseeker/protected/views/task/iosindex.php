...
if (is_int($iostatus)) $iolabel = $_iostatuses[$iostatus];
...
<?php $this->widget('application.extensions.lkgrid.LinkmeGridView', array(
	'id'=>'task-grid',
	'dataProvider'=>($currentaction=="hidden") ? $model->hidden()->search() : $model->unhidden()->search(),
	'filter'=>$model,
    'selectableRows' => '2',
	'columns'=>array(
        array(
        ...
        array(
            ...
            'value' => '$data->iostatus ? fixRebuildIOStatus(' . $iostatusesstr . ', $data->iostatus, $data->rebuild) : ""',
            'filter' => $iostatuses,
        ),
        array(
            'name' => 'anchortext',
        ...
        array(
            ...
            'filter' => $channels,
            'visible' => (isVisible('channel_id', $dparr) && !$ispublisher) || isset($roles['InternalOutreach']),
        ),
        /*
        array(
            'name' => 'client_request',
        ...
        */
		...
		array(
			'class'=>'CButtonColumn',
            'template'=>($currentaction =='hidden') ? '' : '{note}',
            'buttons' => array(
                'note' => array(
                    'label' => 'Add Notes',
