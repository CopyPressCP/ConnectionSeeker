...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'livedate'); ?>
        <?php 
        $this->widget('zii.widgets.jui.CJuiDatePicker', array(
            'model'=>$model,
            'name' => 'Task[livedate]',
            'value' => date("Y-m-d", ($model->livedate ? strtotime($model->livedate) : time())), 
        ...
        ?>
		<?php echo $form->error($model,'livedate'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'desired_domain_id'); ?>
		<?php echo $form->textField($model,'desired_domain_id',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'desired_domain_id'); ?>
	</div>
...
<?php if ($model->id && $model->rebuild) {?>
	<div class="row">
		<?php echo $form->labelEx($model,'rebuild'); ?>
        <?php echo $form->checkBox($model,'rebuild', array('class'=>'chkbox')); ?>
		<?php echo $form->error($model,'rebuild'); ?>
	</div>
<?php } ?>
