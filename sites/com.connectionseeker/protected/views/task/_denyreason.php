...
if ($iostatus == 31 || $iostatus == 5) {
    $denyaction = "repair";
} else if($iostatus == 3) {
    $denyaction = "rewindinapprove";
} else {
    $denyaction = "deny";
}
?>
...
$(function() {
    ...
    <?php
    $_btnTitle = (in_array($iostatus, array(31,5))) ? "Completed - In Repair" : "Deny With Reason";
    if ($iostatus == 3) $_btnTitle = "Rewind With Reason";
    ?>
    ...
    $( "#denyreason-form" ).dialog({
        ...
        buttons: {
            "<?php echo $_btnTitle;?>": function() {
                ...
                <?php if ($denyaction == "rewindinapprove") { ?>
                    bValid = bValid && checkLength( denyreason, "reason", 1, 99999 );
                <?php }?>
                ...
                if ( bValid ) {
                    ...
                    $.ajax({
                        'type': 'POST',
                        'dataType': 'json',
                        'url': "<?php echo Yii::app()->createUrl('/ios/reason');?>",
