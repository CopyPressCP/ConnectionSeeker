...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        <?php echo CHtml::label('What do you want to do?', 'Inventory_action');?>

        <?php echo CHtml::dropDownList('Inventory[action]', $_GET['Inventory']['action'], $actions, array('onchange'=>'doAction();', 'prompt'=>'-- Select --','style'=>'width:430px;')); ?>
	</div>
