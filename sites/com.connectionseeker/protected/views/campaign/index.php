...
<?php $this->widget('application.extensions.lkgrid.LinkmeGridView', array(
	...
	'columns'=>array(
        ...
        array(
            'name' => 'name',
            'type' => 'raw',
            'value' => isset($roles['InternalOutreach']) ? 'CHtml::encode($data->name)' : 'CHtml::link(CHtml::encode($data->name), array("task/processing", "campaign_id" =>$data->id))',
        ),
		'domain',
        array(
            'name' => 'client_id',
            ...
            'type' => 'raw',
            'value' => isset($roles['InternalOutreach']) ? 'CHtml::encode($data->rclient->company)' : 'CHtml::link(CHtml::encode($data->rclient->company), array("client/view", "id" =>$data->client_id))',
        ...
        */
        ...
        array(
            'name' => 'rcampaigntask.content_done',
            //'name' => 'content_percentage_done',
            'type' => 'raw',
            'value' => '($data->rcampaigntask->content_done) * 100 ."%"',
            //#'filter' => $doneoptions,
        ),
        array(
            'name' => 'duedate',
		...
		*/
		array(
			'class'=>'CButtonColumn',
            'template'=>'{download} {styleguide} {view} {update} {delete}',
            'buttons' => array(
                'download' => array(
                    'label' => 'Download Tasks',
                    //'visible' => '',
                    'visible' => "'" . !isset($roles['InternalOutreach']) . "'",
                ...
                'styleguide' => array(
                    'label' => 'Style Guide',
                    'imageUrl'=>Yii::app()->theme->baseUrl.'/css/gridview/guide.png',
                    //'url' => '"http://www.connectionseeker.com/assets/styleguide/".$data->styleguide',
                    'url' => '"assets/styleguide/".$data->styleguide',
                    'visible' => '$data->styleguide',
                    'options' => array(
                        'class'=>'styleguide',
                        'target'=>'_blank',
                    ),
