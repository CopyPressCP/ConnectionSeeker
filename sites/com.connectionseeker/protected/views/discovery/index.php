...
<?php $this->widget('application.extensions.lkgrid.LinkmeGridView', array(
	...
	'columns'=>array(
        ...
        array(
            'name' => 'rdomain.category',
            'type' => 'raw',
            'value' => 'CHtml::dropDownList("rdomain.category", fmtCategory($data->rdomain->category), '.$categorystr.')',
        ),
...
$(document).ready(function() {
    ...
    $.fn.yiiGridView.defaults.afterAjaxUpdate = function(){
        $("select[name='rdomain.stype'],select[name='rdomain.otype'],select[name='rdomain.category']").each(function() {
            //way 1
