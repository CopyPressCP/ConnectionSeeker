  ...
  <tr>
    <td>
        <div class="form">
            ...
            <?php echo CHtml::submitButton('Search', array('id' => 'searchTrails', 'type' => 'submit' , 'value' => 'Search')); ?>
            </div>
        </div>
    </td>
    <td>
        <div class="form">
            <div class="row buttons"> 
            <?php echo CHtml::Button('Download', array('id' => 'downloadTrails', 'type' => 'button', 'value' => 'Download')); ?>
            </div>
        </div>
    </td>
  </tr>
