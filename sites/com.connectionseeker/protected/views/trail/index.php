...
$(document).ready(function() {
    $("#downloadTrails").click(function(){
        var url = "<?php echo Yii::app()->createUrl('/download/trail');?>";
        var rparent = $('#trailSearchForm input[type=hidden][name=r]').parent();
        var rself = rparent.html();
        $('#trailSearchForm input[type=hidden][name=r]').remove();
        //alert($('#trailSearchForm').serialize());
        url = url + "&" + $('#trailSearchForm').serialize();
        rparent.html(rself);
