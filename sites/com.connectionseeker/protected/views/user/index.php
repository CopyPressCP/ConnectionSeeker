...
<?php $this->widget('application.extensions.lkgrid.LinkmeGridView', array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'name' => 'authrole',
            'type' => 'raw',
            'value' => '$data->rauthassignment->itemname',
            'filter' => CHtml::listData(AuthAssignment::model()->findAll(),'itemname','itemname'),
        ),
        array(
            'name' => 'status',
            'type' => 'raw',
		...
		*/
		array(
			'class'=>'CButtonColumn',
            'template'=>'{keygen} {view} {update} {delete}',
            'buttons' => array(
                'keygen' => array(
                    'label' => 'Generate User API Key',
                    'imageUrl'=>Yii::app()->theme->baseUrl.'/css/gridview/keygen.png',
                    'url' => 'Yii::app()->createUrl("user/generate", array("id"=>$data->id))',
                    /*
                    'click' => "function(){
                        //do nothing;
                        return false;
