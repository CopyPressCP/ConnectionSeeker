...
?>
	...
	<div class="row horizonleft">
		<?php echo $form->labelEx($model,'email_upon_completion'); ?>
		<?php echo $form->checkBox($model,'email_upon_completion', array('class'=>'chkbox')); ?>
		<?php echo $form->error($model,'email_upon_completion'); ?>
	</div>
    <div class="clear"></div>
	<div class="row horizonleft">
