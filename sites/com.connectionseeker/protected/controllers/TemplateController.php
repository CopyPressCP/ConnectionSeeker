...
class TemplateController extends RController
{
	/**
	...
	public function actionReplacement($id)
	{
        $rs = array();
        if ($id) {
            $tpl = $this->loadModel($id);

            $rs['subject'] = $tpl->subject;
            $rs['content'] = $tpl->content;
        } else {
            $rs['subject'] = "";
            $rs['content'] = "";
        }
