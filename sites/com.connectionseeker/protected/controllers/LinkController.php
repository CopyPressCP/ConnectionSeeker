...
class LinkController extends RController
{
	...
	public function filters()
	{
		...
		return array(
            ...
            //####this one is disable the whole controller for some reason, so when we wanna turn on the actions which inside the controller, we can comments out the following line
            'disableWholeLink',
		);
	}
	 ...
	 */
    public function filterDisableWholeLink($filterChain) {
        //Disable the whole controller, so we couldn't touch the pages link/* any more
