    ...
    <div id="contentmain">
      <div id="acct">
		<ul>
			...
			<li><img src="<?php echo Yii::app()->theme->baseUrl ; ?>/images/nav-icons/help.png" /><?php echo CHtml::link(Yii::t('user', 'Help'),array('/site/help')); ?></li>
...
<div id="contbottom">
	<div class="contbottom-wrapper">
		<div class="contbottom-nav">
			<ul>
				<li><a target="_blank" href="<?php echo Yii::app()->createUrl("site/about"); ?>">About</a></li>
				<li>Contact</li>
				<li>TOS</li>
				<li class="last"><a target="_blank" href="<?php echo Yii::app()->createUrl("site/privacy"); ?>">Privacy Policy</a></li>
			</ul>
		</div>
		<div class="contbottom-copy">
			Copyright &copy; 2012 by <a href="http://www.steelcast.com">SteelCast.com</a>. All Rights Reserved.
		</div>
	</div>
</div>
