...
<div class="grid_16 logo"><a href="http://dev.connectionseeker.com"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo.png"></a></div>
<div class="clear">&nbsp;</div>
    ...
    <div id="contentpane">
        <div id="topnav">
          <div id="logo">
            ...
            <img height="78" width="555" border="0" alt="Connectionseeker" src="<?php //echo Yii::app()->theme->baseUrl; ?>/images/logo.png"></a>
          </div>
          <div id="rightsubnav">
            <a href="<?php //echo Yii::app()->createUrl('/site/login');?>" class="linkbutton"> Sign In </a>
          </div>
        </div>
        <div class="clear"></div>
        <div id="navmenu">
...
-->
    ...
    <div class="footercp">
        Copyright &copy; <?php echo date('Y'); ?> by SteelCast.com. All Rights Reserved.<br/>
        <?php echo 'Powered By <a href="http://www.steelcast.com/portfolio/#hua" rel="external">Steelcast.com</a>'; ?>
    </div><!-- footer -->
</div><!-- page -->
