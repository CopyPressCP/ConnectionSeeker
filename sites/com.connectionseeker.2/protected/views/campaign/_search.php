...
<table border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="formSearch" ><?php echo $form->textField($model,'name',array('size'=>60,'maxlength'=>255)); ?>
</td>
  ...
  <tr>
	...
	<td class="txtfrm" height="50" ><?php echo $form->label($model,'category'); ?>
</td>
	<td class="formSearch" ><?php echo $form->textField($model,'category'); ?>
</td>
  </tr>
  <tr>
	<td class="txtfrm" height="50" ><?php echo $form->label($model,'category_str'); ?>
</td>
	<td class="formSearch" ><?php echo $form->textArea($model,'category_str',array('rows'=>6, 'cols'=>50)); ?>
</td>
