...
<table border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="formSearch" ><?php echo $form->textField($model,'type',array('size'=>7,'maxlength'=>7)); ?>
</td>
	<td class="txtfrm" height="50" ><?php echo $form->label($model,'blackvalue'); ?>
</td>
	<td class="formSearch" ><?php echo $form->textField($model,'blackvalue',array('size'=>60,'maxlength'=>500)); ?>
</td>
  </tr>
  <tr>
	<td class="txtfrm" height="50" ><?php echo $form->label($model,'channel_id'); ?>
</td>
	<td class="formSearch" ><?php echo $form->textField($model,'channel_id'); ?>
</td>
