<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('assignee')); ?>:</b>
	<?php echo CHtml::encode($data->assignee); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('last_visit_ip')); ?>:</b>
	<?php echo CHtml::encode($data->last_visit_ip); ?>
	<br />
